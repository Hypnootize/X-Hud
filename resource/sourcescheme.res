// SourceScheme originally from rayshud, edited for xHud by Hergan
//
...
Scheme
{
	Colors
	{
		...
		"RaysPrimaryLight"		"100 100 100 255"
	...
	BaseSettings
	{
		...
		Border.Bright					"xattuuGrey"
		Border.Dark						"xattuuDarkGrey"
		Border.Selection				"40 40 40 196"default/selected button
		...
		CheckButton.HighlightFgColor	"xattuuGrey"
		...
		FrameTitleBar.TextColor			"xattuuWhite"
		...
		MainMenu.ArmedTextColor		"xattuuWhite"
		MainMenu.Inset				"32"
		
		Menu.TextInset					"6"
		Menu.FgColor			"White"
		Menu.BgColor					"160 160 160 64"
		Menu.ArmedFgColor		"xattuuDarkGrey"
		Menu.ArmedBgColor				"xattuuDarkGrey"
		...
		TextEntry.SelectedBgColor	"xattuuDarkGrey"
